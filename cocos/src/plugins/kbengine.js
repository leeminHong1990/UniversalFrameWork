...
KBEngine.KBEngineApp = function(kbengineArgs)
{
	...
	this.reset = function()
	{
		...
		KBEngine.app.clientVersion = "1.1.6";
	...
	{  
		...
		KBEngine.app.resetSocket();
		KBEngine.Event.fire("onConnectionState", false);
		h1global.globalUIMgr.info_ui.show_by_info("连接失败，请检查网络！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){cc.loader.load("src" + "/" + "return.js");}else{window.location.href = switches.h5entrylink;}});
	}
	...
	this.onerror_after_onopen = function(evt)
	{
		...
		h1global.globalUIMgr.info_ui.show_by_info("连接错误，请重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){cc.loader.load("src" + "/" + "return.js");}else{window.location.href = switches.h5entrylink;}});
	}
	...
	this.onclose = function()
	{
		...
		//if(KBEngine.app.currserver != "loginapp")
		//	KBEngine.app.reset();
		if(cc.director.getRunningScene().className !== "LoginScene"){
			...
			if(info_json){
				...
				if((cc.sys.os === cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os === cc.sys.OS_IOS && cc.sys.isNative)){
					KBEngine.app.login("wx_" + info_dict["unionid"], info_dict["password"], JSON.stringify({"userId":info_dict["user_id"], "sex":info_dict["sex"], "version":app_version}));
				} else {
					KBEngine.app.login("wx_" + info_dict["unionid"], info_dict["password"], JSON.stringify({"userId":info_dict["user_id"], "sex":info_dict["sex"], "version":app_version}));
				}
			}

			// h1global.globalUIMgr.info_ui.show_by_info("连接超时，请重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){cc.loader.load("src" + "/" + "return.js");}else{window.location.href = switches.h5entrylink;}})
		}
	}
	...
	this.close = function() {
		...
		KBEngine.app.reset();
		h1global.globalUIMgr.info_ui.show_by_info("连接已断开，请重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){cc.loader.load("src" + "/" + "return.js");}else{window.location.href = switches.h5entrylink;}})
	}
	...
	*/
	...
	this.Client_onLoginFailed = function(args)
	{
		...
		if (KBEngine.app.serverErrs[failedcode].name === "SERVER_ERR_USER1") {
			h1global.globalUIMgr.info_ui.show_by_info("客户端版本过低, 请删除旧的客户端, 下载新的客户端进行游戏！", cc.size(600, 400), function () {
				cutil.open_url(switches.download_url);
			}, false)
		} else {
	...
	this.Client_onLoginBaseappFailed = function(failedcode)
	{
		...
		h1global.globalUIMgr.info_ui.show_by_info("连接失败，请重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){cc.loader.load("src" + "/" + "return.js");}else{window.location.href = switches.h5entrylink;}})
	}
	...
	this.Client_onKicked = function(failedcode)
	{
		...
		h1global.globalUIMgr.info_ui.show_by_info("与服务器断开连接，请稍后重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){cc.loader.load("src" + "/" + "return.js");}else{window.location.href = switches.h5entrylink;}})
	}
