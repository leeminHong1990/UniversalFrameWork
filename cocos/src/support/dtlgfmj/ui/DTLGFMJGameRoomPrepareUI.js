...
var DTLGFMJGameRoomPrepareUI = UIBase.extend({
	ctor:function() {
		this._super();
		this.resourceFilename = "res/ui/DTLGFMJGameRoomPrepareUI.json";
		this.talk_img_num = 0;
	},
	...
	initUI:function(){
        ...
        var share_title = cutil.get_share_title(player.curGameRoom,const_val.DaTongLGFMJ);

        var share_desc = cutil.get_share_desc(player.curGameRoom,const_val.DaTongLGFMJ);
