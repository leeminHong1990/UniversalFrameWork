var DTLGFMJPlaybackGameRoomScene = cc.Scene.extend({
    className: "DTLGFMJPlaybackGameRoomScene",
		    ...
		    h1global.curUIMgr.roomLayoutMgr.showGameRoomUI(function (complete) {
			    if (complete) {
				    ...
				    if (player.curGameRoom.kingTiles.length > 0) {
					    h1global.curUIMgr.roomLayoutMgr.notifyObserver("set_kingtile_panel_visible", true)
				    }
