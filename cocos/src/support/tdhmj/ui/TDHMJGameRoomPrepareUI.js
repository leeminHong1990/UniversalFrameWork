...
"use strict";
var TDHMJGameRoomPrepareUI = UIBase.extend({
	ctor:function() {
		this._super();
		this.resourceFilename = "res/ui/TDHMJGameRoomPrepareUI.json";
		this.talk_img_num = 0;
	},
	...
	initUI:function(){
        ...
        // var share_title = cutil.get_share_title(player.curGameRoom,const_val.TuiDaoHuMJ);
        var share_title = '';

        //var share_desc = this.get_share_desc();
        var share_desc = cutil.get_share_desc(player.curGameRoom,const_val.TuiDaoHuMJ);
		...
		wxinvite_btn.addTouchEventListener(function(sender, eventType){
			if(eventType == ccui.Widget.TOUCH_ENDED){
                ...
                share_title = cutil.get_share_title(player.curGameRoom,const_val.TuiDaoHuMJ);
