"use strict";
var TYKDDMJGameRoomPrepareUI = UIBase.extend({
    ctor:function() {
        this._super();
        this.resourceFilename = "res/ui/TYKDDMJGameRoomPrepareUI.json";
        this.talk_img_num = 0;
    },
    ...
    initUI:function(){
        ...
        wxinvite_btn.addTouchEventListener(function(sender, eventType){
            if(eventType == ccui.Widget.TOUCH_ENDED){
                ...
                share_title = cutil.get_share_title(player.curGameRoom,const_val.TaiYuanKDDMJ);
