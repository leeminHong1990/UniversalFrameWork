...
var TYKDDMJGameRoomScene = cc.Scene.extend({
    className:"TYKDDMJGameRoomScene",
    ...
    onEnter:function () {
        ...
        if (cc.sys.localStorage.getItem(cutil.keyConvert("GAME_ROOM_UI", this.gameType)) == null) {
            cc.sys.localStorage.setItem(cutil.keyConvert("GAME_ROOM_UI", this.gameType), const_val.GAME_ROOM_3D_UI)
        }
		        ...
		        if (h1global.curUIMgr.roomLayoutMgr) {
			        ...
			        h1global.curUIMgr.roomLayoutMgr.showGameRoomUI(function (complete) {
				        if (complete) {
					        ...
					        h1global.curUIMgr.roomLayoutMgr.setGameRoomUI2Top(cc.sys.localStorage.getItem(cutil.keyConvert("GAME_ROOM_UI", this.gameType)))
				        }
			        });
		        }
	        } else {
