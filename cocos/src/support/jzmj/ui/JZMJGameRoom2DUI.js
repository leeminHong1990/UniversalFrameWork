...
var JZMJGameRoom2DUI = JZMJGameRoomUI.extend({
    className: "JZMJGameRoom2DUI",
    ...
    get_play_discard_anim_config: function (serverSitNum, index, onlyTilePointer) {
        ...
        if(discardTileIdx > const_jzmj.MAX_DISCARD_TILES_SIZE){
            discardTileIdx = Math.min(discardTileIdx , const_jzmj.MAX_DISCARD_TILES_SIZE);
        }
