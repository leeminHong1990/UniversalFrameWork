...
"use strict";
var JZMJGameRoomPrepareUI = UIBase.extend({
	ctor:function() {
		this._super();
		this.resourceFilename = "res/ui/JZMJGameRoomPrepareUI.json";
		this.talk_img_num = 0;
	},
	...
	initUI:function(){
        ...
        var share_desc = cutil.get_share_desc(player.curGameRoom,const_val.JinZhongMJ);
		...
		wxinvite_btn.addTouchEventListener(function(sender, eventType){
			if(eventType == ccui.Widget.TOUCH_ENDED){
                ...
                share_title = cutil.get_share_title(player.curGameRoom,const_val.JinZhongMJ);
