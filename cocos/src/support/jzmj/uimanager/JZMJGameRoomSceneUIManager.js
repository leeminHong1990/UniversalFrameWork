var JZMJGameRoomSceneUIManager = UIManagerBase.extend({
	...
	onCreate: function () {
		...
		var initUIClassNameList = ["AudioRecordUI", "HelpUI", "GameConfigUI", "GamePlayerInfoUI", "CommunicateUI", "ApplyCloseUI", "GPSUI","GPSceneUI","ClubInviteUI", "ConfirmUI", "ShareSelectUI"];
		...
		for (var uiClassName in ui_dict["GAME_ROOM_INFO_UI"]) {
			this.add_ui(uiClassName.slice(0, uiClassName.length - 2).toLowerCase() + "_ui", [], ui_dict["GAME_ROOM_INFO_UI"][uiClassName]);
		}
