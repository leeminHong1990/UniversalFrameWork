var TYLSMJGameRoomSceneUIManager = UIManagerBase.extend({
	...
	onCreate: function () {
		...
		var initUIClassNameList = ["TYLSMJGameRoomInfoUI", "GameRoomInfoUI", "AudioRecordUI", "HelpUI", "GameConfigUI", "GamePlayerInfoUI", "CommunicateUI", "ApplyCloseUI", "GPSUI","GPSceneUI","ClubInviteUI", "ConfirmUI", "ShareSelectUI"];
