var FYQYMMJPlaybackGameRoomScene = cc.Scene.extend({
    className: "FYQYMMJPlaybackGameRoomScene",
            ...
            h1global.curUIMgr.roomLayoutMgr.showGameRoomUI(function (complete) {
                if (complete) {
                    ...
                    // if (player.curGameRoom.kingTiles.length > 0) {
                        // h1global.curUIMgr.roomLayoutMgr.notifyObserver("_setBeginGameShow", true)
                    // }
