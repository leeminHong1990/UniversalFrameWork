...
var LLKDDMJGameRules = LLKDDMJRoomOperationAdapter.extend({
    ...
    nomalCanWin: function (handTiles, finalTile, serverSitNum, aid) {
	    ...
	    if (((this.curGameRoom.game_mode === const_llkddmj.KING_GAME_MODE && this.curGameRoom.seven_pair === 1) || this.curGameRoom.game_mode !== const_tykddmj.KING_GAME_MODE) && cutil_llkddmj.checkIs7Pairs(handTilesButKing, kingTilesNum)) {              // 7对
	        return true;
