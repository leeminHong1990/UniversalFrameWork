var LoginScene = cc.Scene.extend({
    ...
    onEnter: function () {
        ...
        if (!((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) || switches.TEST_OPTION)) {
            ...
            if (src.indexOf("?code=") >= 0) {
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        ...
                        KBEngine.app.login("wx_" + info_dict["unionid"], info_dict["unionid"], JSON.stringify({"userId":info_dict["user_id"], "sex":info_dict["sex"], "version":app_version}));
                    }
                };
                xhr.send();
            } else {
            ...
            version_xhr.open("GET", serverconfig.versionUrl, true);
